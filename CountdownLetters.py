...
def importFile():
    # import the dictionary and return it without the newlines and dashes as a list
...
def compare(words, letters):
    # compare the sorted and refined words against the chosen letters
    inPromptList = []
...
def lettersRound(letters):
    ...
    print(f"10 best words are: {fiveBestWord}")
    t1 = time.time()
